...
public class MailUtil implements Runnable {
    ...
    public void run() {
        ...
        // 3.发送一封激活邮件
        String from = "1441732331@qq.com";// 发件人电子邮箱
        ...
        try {
            ...
            Session session = Session.getDefaultInstance(properties, new Authenticator() {
                public PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("1441732331@qq.com", "chpdvwohdrhthgej"); // 发件人邮箱账号、授权码
                }
            });
            ...
            String content = "<html><head></head><body><h1>这是一封激活邮件,激活请点击以下链接</h1><h3><a href='http://localhost:8080/RegisterDemo/ActiveServlet?code="
                    + code + "'>http://localhost:8080/member/verification?code=" + code
                    + "</href></h3></body></html>";
